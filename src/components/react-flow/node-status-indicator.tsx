...
export const BorderLoadingIndicator = ({
  ...
  return (
    <>
      <div className="absolute -top-[2px] -left-[2px] h-[calc(100%+3.5px)] w-[calc(100%+3.5px)]">
        <style>
          {`
        @keyframes spin {
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "absolute -top-[2px] -left-[2px] h-[calc(100%+3.5px)] w-[calc(100%+3.5px)] rounded-md border-3",
          className,
        )}
      />
      {children}
